...
#cria a coluna abaixo do titulo com todos valores de colunas para filtrar o DF
...
## Filtro das colunas. As colunas Nome do Produto, Preço do Produto e Data da compra foram feitas na aula, as demais passadas como desafio
# Filtro da coluna 1:
...
#Filtro da coluna 10:
with st.sidebar.expander('Qauantidade de parcelas'):
...
with coluna1:
    ...
    nome_arquivo += '.csv'
with coluna2:
    st.download_button('Fazer o download do arquivo em csv', data = converte_csv(dados_filtrados), file_name = nome_arquivo, 
